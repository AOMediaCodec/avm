...
static void set_good_speed_features_framesize_independent(
  ...
  if (speed >= 1) {
    ...
    sf->part_sf.enable_six_param_warp_in_winner_mode = 1;
    if (sf->part_sf.enable_six_param_warp_in_winner_mode) {
      sf->winner_mode_sf.motion_mode_for_winner_cand = 2;
      sf->part_sf.enable_six_param_warp_in_winner_mode_by_tid =
...
static AVM_INLINE void init_part_sf(PARTITION_SPEED_FEATURES *part_sf) {
  ...
  part_sf->enable_six_param_warp_in_winner_mode = 0;
  part_sf->enable_six_param_warp_in_winner_mode_by_tid = 0;
