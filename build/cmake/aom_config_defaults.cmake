...
set_aom_config_var(CONFIG_MULTIVIEW_CORE 1 "Core changes in the codebase for multiview coding support.")
set_aom_config_var(CONFIG_MULTIVIEW_SEPARATE_DPB 1 "separate dpb support for multiview.")
set_aom_config_var(CONFIG_MULTIVIEW_EXTENDED_DPB 1 "extended dpb support for multiview.")

set_aom_config_var(CONFIG_MULTIVIEW_DEBUG 0 "Debug functionality macro for multiview coding.")
set_aom_config_var(CONFIG_MULTIVIEW_DEBUG_PROMPT 0 "Debug macro for prompting on display.")
set_aom_config_var(CONFIG_MULTIVIEW_DEBUG_LOGFILES 0 "Debug create logfiles for encode and decode.")

set_aom_config_var(CONFIG_MULTILAYER_TEMPORAL_SCALABILITY_REFLIST 1
                   "Enable temporal scalability using the implicit reference frame list construction")
set_aom_config_var(CONFIG_MULTILAYER_TEMPORAL_SCALABILITY_ENCODER 0
                   "Enable temporal scalability encoding with ref map slot allocation and frame drop")
# Bugfix for error resilience case for CONFIG_MULTILAYER_TEMPORAL_SCALABILITY_REFLIST
set_aom_config_var(CONFIG_MULTILAYER_TEMPORAL_SCALABILITY_REFLIST_FIX_ERROR_RES 0
                   "Enable temporal scalability using the implicit reference frame list construction")
