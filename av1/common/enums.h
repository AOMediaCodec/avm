...
#define MAX_LCR_CNT (1 << LCR_ID_BITS)
#define MAX_NUM_EMBEDDED_LAYERS 8
#define MAX_NUM_EXTENDED_LAYERS 32
#define MAX_ATLAS_SEGMENTS 64
#define MAX_REGIONS 64
#define MAX_OPS_CNT 16
#define MAX_ATLAS_CNT 8
#define MAX_XLAYER_CNT 32
#define MAX_LCR_TYPES 2
#define MAX_ATLAS_SEG_ID 8
...
enum { ENH_ATLAS, BASIC_ATLAS, SINGLE_ATLAS, ATLAS_TYPES };

enum {
  UNSPECIFIED,
  STEREOSCIPIC_VIEWPORTS,
