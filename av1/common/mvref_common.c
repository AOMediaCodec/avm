...
#if CONFIG_F322_OBUER_REFRESTRICT
  cm->cur_frame->display_order_hint_removed =
      cm->current_frame.display_order_hint_removed;
#endif
...
#if 0
  printf("<<%s>> valid_ref_num:%d %d vs %d\n", __func__, valid_ref_num, cm->ref_frames_info.num_total_refs,  cm->ref_frames_info.num_valid_refs_without_restricted_ref);
#endif
#endif
...
void av1_setup_skip_mode_allowed(AV1_COMMON *cm) {
  ...
  //[jkei] this num total needs to include restricted or not?
