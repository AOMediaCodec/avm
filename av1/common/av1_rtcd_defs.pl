...
add_proto qw/void gdf_intra_inference_block/, "const int i_min, const int i_max, const int j_min, const int j_max,
                      const int stripe_size, const int qp_idx, const uint16_t* rec_pnt, const int rec_stride, const int bit_depth,
                      int16_t* err_pnt, const int err_stride, const int pxl_shift, const int ref_dst_idx";
specialize qw/gdf_intra_inference_block avx2/;

add_proto qw/void gdf_inter_inference_block/, "const int i_min, const int i_max, const int j_min, const int j_max,
                      const int stripe_size, const int qp_idx, const uint16_t* rec_pnt, const int rec_stride, const int bit_depth,
                      int16_t* err_pnt, const int err_stride, const int pxl_shift, const int ref_dst_idx";
specialize qw/gdf_inter_inference_block avx2/;

add_proto qw/void gdf_compensation_block/, "uint16_t* rec_pnt, const int rec_stride,
    				  int16_t* err_pnt, const int err_stride, const int err_shift, const int scale, const int pxl_max, const int blk_height, const int blk_width";
