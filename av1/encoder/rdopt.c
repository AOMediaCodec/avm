...
static int av1_adjust_mvs_for_derive_sign_local_search(
...
static int av1_adjust_mvs_for_derive_sign_clean(
    const AV1_COMP *const cpi, MACROBLOCK *x, BLOCK_SIZE bsize,
    const BUFFER_SET *orig_dst, int start_signaled_mv_ref_idx,
    int num_signaled_mvd, MV mv_diff[2], MV ref_mvs[2], int rate2_nocoeff,
  ...
  if (num_signaled_mvd < 2) {
    return av1_adjust_mvs_for_derive_sign_local_search(
        ...
        // handle_inter_mode()
          ...
          if (is_mvd_sign_derive_allowed(cm, xd, mbmi)) {
            ...
            if (need_mv_adjustment(xd, cm, x, mbmi, bsize, mv_diff, ref_mvs,
              ...
              if (!av1_adjust_mvs_for_derive_sign_clean(
