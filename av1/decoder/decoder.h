...
typedef struct AV1Decoder {
  ...
  // 15 QM OBUs can be saved due to the qm_bit_map uniqueness constraint
  ...
  // sequence header
  // qm_list[15] is assigned to the flat matrix
  struct quantization_matrix_set qm_list[NUM_QM_LEVELS];
