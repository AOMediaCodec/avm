...
typedef enum {
  ...
  OBU_METADATA_TYPE_ITUT_T35 = 3,
  OBU_METADATA_TYPE_TIMECODE = 4,
  OBU_METADATA_TYPE_DECODED_FRAME_HASH = 5,
  OBU_METADATA_TYPE_BANDING_HINTS = 6,
#if CONFIG_ICC_METADATA
  OBU_METADATA_TYPE_ICC_PROFILE = 7,
#endif  // CONFIG_ICC_METADATA
#if CONFIG_SCAN_TYPE_METADATA
  OBU_METADATA_TYPE_SCAN_TYPE = 8,
#endif  // CONFIG_SCAN_TYPE_METADATA
#if CONFIG_CWG_F430
  OBU_METADATA_TYPE_TEMPORAL_POINT_INFO = 9,
