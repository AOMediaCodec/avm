...
typedef enum ATTRIBUTE_PACKED {
  ...
  OBU_LAYER_CONFIGURATION_RECORD = 1,
  OBU_ATLAS_SEGMENT = 2,
  OBU_OPERATING_POINT_SET = 3,
  OBU_SEQUENCE_HEADER = 4,
  OBU_TEMPORAL_DELIMITER = 5,
  OBU_FRAME_HEADER = 6,
  OBU_TILE_GROUP = 7,
  OBU_METADATA = 8,
  OBU_FRAME = 9,
  OBU_REDUNDANT_FRAME_HEADER = 10,
  OBU_TILE_LIST = 11,
#if CONFIG_MULTI_STREAM
  OBU_MULTI_STREAM_HEADER = 12,
