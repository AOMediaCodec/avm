...
class TemporalLayersTestLarge : public ::libavm_test::CodecTestWithParam<int>,
 ...
 protected:
  ...
  virtual void SetUp() {
    ...
    cfg_.rc_min_quantizer = 100;
    cfg_.rc_max_quantizer = 100;
    cfg_.g_threads = 2;
...
TEST_P(TemporalLayersTestLarge, TemporalLayersTest2TL) {
  ::libavm_test::Y4mVideoSource video_nonsc("paris_352_288_30.y4m", 0, 30);
...
AV2_INSTANTIATE_TEST_SUITE(TemporalLayersTestLarge, ::testing::Values(4));
}  // namespace
