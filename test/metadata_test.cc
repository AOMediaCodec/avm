...
#if F106_OBU_TILEGROUP || F106_OBU_SEF || F106_OBU_SWITCH || F106_OBU_TIP
...
const uint8_t kMetadataObuT35[kMetadataObuSizeT35] = {
  kOH0, 0x14, 0x04, 0xB5, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
...
const uint8_t kMetadataObuMdcv[kMetadataObuSizeMdcv] = {
  kOH0, 0x14, 0x02, 0xB5, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
  0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10,
  0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x80
};
...
const size_t kMetadataObuSizeMdcv = 28;
const uint8_t kMetadataObuMdcv[kMetadataObuSizeMdcv] = {
  kOH0, 0x1A, 0x02, 0xB5, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
  0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10,
  0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x80
};
const size_t kMetadataObuSizeCll = 8;
const uint8_t kMetadataObuCll[kMetadataObuSizeCll] = { kOH0, 0x06, 0x01, 0xB5,
                                                       0x01, 0x02, 0x03, 0x80 };
