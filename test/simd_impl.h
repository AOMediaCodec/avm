...
INSTANTIATE(
    ...
    SIMD_TUPLE(v256_sadd_u8, 0U, 0U), SIMD_TUPLE(v256_rdavg_u16, 0U, 0U),
    SIMD_TUPLE(imm_v256_align<2>, 0U, 0U), SIMD_TUPLE(v256_unziphi_64, 0U, 0U),
    SIMD_TUPLE(v256_unziplo_64, 0U, 0U), SIMD_TUPLE(imm_v256_align<3>, 0U, 0U),
